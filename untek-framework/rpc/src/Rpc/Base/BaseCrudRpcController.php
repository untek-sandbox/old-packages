...
abstract class BaseCrudRpcController extends BaseRpcController
{
    ...
    protected function createFormInstance(RpcRequestEntity $rpcRequestEntity, string $formClass = null): object
    {
        $params = $rpcRequestEntity->getParams();
        $formInstance = ClassHelper::createInstance($formClass ?: $this->formClass);
